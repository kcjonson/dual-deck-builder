...
export class SplashScreen extends Screen {
  ...
  private fadeInTime: number = 1.0; // Time in seconds to fade in
  private displayTime: number = 2.0; // Time in seconds to display the splash
  private fadeOutTime: number = 1.0; // Time in seconds to fade out
  ...
  protected onUpdate(dt: number): void {
    ...
    if (this.currentTime < this.fadeInTime) {
      ...
      // Fade out phase
      const fadeOutProgress = (this.currentTime - this.fadeInTime - this.displayTime) / this.fadeOutTime;
