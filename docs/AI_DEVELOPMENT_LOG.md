...
**What landed:** DDB-132, the model half of DDB-33, stacked on the road-grid PR.
...
- Tests: 19 new in `EnemyIntents.test.ts`; three existing tests updated for planning.
